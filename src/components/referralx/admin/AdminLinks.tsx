...
const links = [
  { name: "SaaS Landing Page", url: "https://referralx.com/ref/admin-saas-2024", clicks: 1243, conversions: 67, rate: "5.4%", status: "active" as const },
  { name: "Toolkit Promo Page", url: "https://referralx.com/ref/admin-toolkit-2024", clicks: 892, conversions: 45, rate: "5.0%", status: "active" as const },
  { name: "Design Course Page", url: "https://referralx.com/ref/admin-design-2024", clicks: 654, conversions: 32, rate: "4.9%", status: "active" as const },
  { name: "DevOps Course Page", url: "https://referralx.com/ref/admin-devops-2024", clicks: 321, conversions: 18, rate: "5.6%", status: "inactive" as const },
  { name: "Marketing Page", url: "https://referralx.com/ref/admin-marketing-2024", clicks: 567, conversions: 28, rate: "4.9%", status: "active" as const },
  { name: "API Docs Page", url: "https://referralx.com/ref/admin-api-2024", clicks: 234, conversions: 12, rate: "5.1%", status: "pending" as const },
];
export function AdminLinks() {
  return (<div className="space-y-6">
    <div className="flex items-center justify-between"><div><h3 className="text-lg font-semibold text-rx-gray-800">Tracking Links</h3><p className="text-sm text-rx-gray-500">Manage and monitor your referral tracking links</p></div><button className="inline-flex items-center gap-2 px-4 py-2.5 bg-rx-primary text-white rounded-lg text-sm font-semibold hover:bg-rx-primary-dark"><Plus className="w-4 h-4"/> Create Link</button></div>
